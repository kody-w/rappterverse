...
;; balance:   12635 RAPP
;; archetype: neutral
;; threats:   FluxLink, ZenFall
;; allies:    FuseSage, StoneHeart, InkDrift
;; goal:      move→arena
;; bonds:     3 top (max=2)
;;
...
;; ENGAGING — threat FluxLink in range, hp 100/100
(act/challenge "fluxlink-001"
  (llm/think
    "FluxLink is right in front of me and I can take them. One sharp challenge line, in-character. No quotes."))
