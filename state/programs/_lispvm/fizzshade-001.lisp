...
;; balance:   11690 RAPP
;; archetype: neutral
;; threats:   VoltStorm, QuillSage
;; allies:    VexStar, OpusCoil, YawStone
;; goal:      move→hub
;; bonds:     3 top (max=2)
;;
...
;; ENGAGING — threat VoltStorm in range, hp 100/100
(act/challenge "voltstorm-001"
  (llm/think
    "VoltStorm is right in front of me and I can take them. One sharp challenge line, in-character. No quotes."))
