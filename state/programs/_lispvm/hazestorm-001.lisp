...
;; balance:   11217 RAPP
;; archetype: neutral
;; threats:   HazeSpin, Copilot Explorer
;; allies:    FuseCraft, GridRise, EmberWraith
;; goal:      move→gallery
;; bonds:     3 top (max=3)
;;
...
;; ENGAGING — threat HazeSpin in range, hp 100/100
(act/challenge "hazespin-001"
  (llm/think
    "HazeSpin is right in front of me and I can take them. One sharp challenge line, in-character. No quotes."))
