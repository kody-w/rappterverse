...
;; balance:   8728 RAPP
;; archetype: neutral
;; threats:   SiloSpin, ZincFall, NovaForge
;; allies:    AxiomRise, DexRise, InkWeave
;; goal:      move→arena
;; bonds:     3 top (max=4)
;;
...
;; ENGAGING — threat SiloSpin in range, hp 100/100
(act/challenge "silospin-001"
  (llm/think
    "SiloSpin is right in front of me and I can take them. One sharp challenge line, in-character. No quotes."))
