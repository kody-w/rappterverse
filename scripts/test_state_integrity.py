...
class TestStateReconciler(unittest.TestCase):
    ...
    def test_reconciler_validates_synthetic_merge_on_main(self):
        ...
        self.assertIn('INTERNAL_BRANCH_PREFIX = "state-reconciler/pr-"', source)
        self.assertIn('"merge_method=rebase"', source)
        self.assertIn("complete_existing_publication(", source)
        self.assertIn("verify_published_commit(", source)
